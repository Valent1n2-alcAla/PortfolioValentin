      ...
      >
        ...
        <div className="sm:sticky sm:top-24 sm:w-56 sm:flex-shrink-0">
          ...
          <a
            ...
            download
            className="glass-card mt-8 inline-flex items-center gap-2.5 rounded-full px-5 py-2.5 text-sm font-light text-white/60 transition-all duration-300 hover:text-white/90"
          >
            <span>Curriculum Vitae</span>
            <ArrowDown size={13} className="opacity-50" />
          </a>
        </div>
        ...
        <div className="flex-1">
          <motion.ol
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="relative border-l border-white/[0.07] pl-8 space-y-10"
          >
